	...
	For better comparability with \citeauthor{Nur} and \citeauthor{Ye}, I analyse the same elements of Interpersonal Metafunction: mood, modality and personal pronouns.
 	...
 	\subsection{Mood}{
		...
		%    - imperative example:
 		...
 		In the other cases -- when addressing Americans -- all imperatives are used not in the usual way (to command), but instead using ``let'' to invite listeners to join in and act together.
